    ...
    var body: some View {
        ...
        .onChange(of: click) {
            ...
            if viewModel.isValidated() {
                viewModel.clickButton(event: .internship, click: $0, start: eventTime, end: endTime)
                action()
            }
        }
    }
...
#Preview {
    ...
    InternshipView(viewModel: viewModel, click: .constant(false), eventTime: date, endTime: date) {}
}
